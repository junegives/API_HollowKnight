...
void CBoomerang::Render(HDC _hDC)
{
...
void CBoomerang::OnCollided(CObject* _pObject)
{
}

void CBoomerang::OnCollided(CObject* _pObject, EDirection _eDirection)
{
}

bool CBoomerang::CalcPath()
{
	if (100 > m_iTime)
	{
